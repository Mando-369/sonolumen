"""sonolumen.material — §13 material stress, erosion, lifetime.
...
from sonolumen.material import materials
from sonolumen.material.erosion import (
...
from sonolumen.material.thermal import ThermalState, predict_thermal_equilibrium
from sonolumen.material.transducer import (
    TransducerLifetime,
    predict_transducer_lifetime,
)
from sonolumen.material.wall_loads import (
    WallLoadHistory,
    microjet_velocity,
