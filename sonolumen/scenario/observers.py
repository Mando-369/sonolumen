...
All observers reuse v1 `sonolumen.detectors` helpers — Scenario adds the
...
class PMTObserver:
    ...
    def sample(self, sim_result: Any, scenario: Any) -> Any:
        import pandas as pd
        from sonolumen.detectors import pmt_signal
...
class HydrophoneObserver:
    ...
    def sample(self, sim_result: Any, scenario: Any) -> Any:
        import pandas as pd
        from sonolumen.detectors import hydrophone_signal
...
class PickupCoilObserver:
    ...
    def sample(self, sim_result: Any, scenario: Any) -> Any:
        import pandas as pd
        from sonolumen.detectors import pickup_coil_signal
