...
Public entry point:
    ...
    from sonolumen.suggestions import SuggestionsEngine
...
from sonolumen.scenario.types import RegimeLabel, Suggestion

from sonolumen.suggestions import regime as regime_mod
