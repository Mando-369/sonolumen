...
from sonolumen import (
    liquids, drive, seed, bubble_dynamics, thermal, plasma, em_emission,
    detectors, solvers, presets, visualisation,
)
from sonolumen.runner import run, sweep, SimulationResult

# v2 — Scenario layer (§12). Built on top of v1; never modifies it.
from sonolumen import scenario
from sonolumen.scenario import Scenario, ScenarioResult
...
from sonolumen import material, suggestions

# v2 — §15 UI layer. Optional dep (`pip install sonolumen[ui]`); skipped
# if Dash isn't installed.
try:
    from sonolumen import ui                             # noqa: F401
    _has_ui = True
except ImportError:
    _has_ui = False
